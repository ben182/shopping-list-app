...
return [
    ...
    */
    ...
    'app_id' => env('NATIVEPHP_APP_ID') ?: 'de.ben182.einkaufsliste',
    ...
    */
    ...
    'cleanup_env_keys' => [
        ...
        'DB_PASSWORD',
        'DB_USERNAME',
        // Signing credentials: needed by the build host, never by the device.
        // The '*_SECRET' pattern does not cover these names.
        'ANDROID_KEYSTORE_*',
    ...
    */
    ...
    'android' => [
        ...
        */
        'theme' => [
            'color_primary' => env('NATIVEPHP_ANDROID_COLOR_PRIMARY', '#4F46E5'),
            'color_primary_night' => env('NATIVEPHP_ANDROID_COLOR_PRIMARY_NIGHT', '#818CF8'),
